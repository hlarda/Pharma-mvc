...
namespace Pharma.Controllers
{
    public class OrderItemController : Controller
    {
        ...
        public OrderItemController(PharmaContext context)
        {
            _context = context;
        }
        ...
        {
            var pharmaContext = _context.OrderItem.Include(o => o.Order).Include(o => o.Product);
        ...
        public async Task<IActionResult> Create([Bind("OrderItemId,OrderId,ProductId,Quantity,Price")] OrderItem orderItem)
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Set<Product>(), "ProductId", "Description", orderItem.ProductId);
            return View(orderItem);
        }
